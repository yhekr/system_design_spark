...
ODS_PATH = 'data/ods/events/1d/' + DATE_STR
DDS_PATH = 'data/dds/fct_orders_act/1d/' + DATE_STR
...
result = events \
    ...
    .withColumns({
        "delivered_flg": F.col("msk_delivered_dttm").isNotNull(),
        "started_flg": F.col("msk_started_dttm").isNotNull(),
        "assigned_flg": F.col("msk_assigned_dttm").isNotNull(),
        "cancelled_flg": F.col("msk_cancelled_dttm").isNotNull(),
    })
